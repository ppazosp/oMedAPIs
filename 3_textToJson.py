...
@app.route('/getPillInfo', methods=['POST'])
# @auth.login_required
def getPillInfo():
    """
    ...
    json_template = json.dumps({
            "event_json": {
                "frecuencia": "<Veces por día/semana>",
                "primera_ingestion": "<Fecha y hora de la primera toma>",
    ...
    1. **Frecuencia**: Veces por día o semana (ejemplo: "2/day" o "3/week").
    ...
    3. **Parte del cuerpo afectada**: Indicar la parte del cuerpo a la que se refiere el medicamento (ejemplo: "heart", "lungs", "stomach").
    ...
    **Texto de transcripción:**
    ...
    try:
        response = client.chat.completions.create(
            model="gpt-4o-mini",
            messages=[
                {"role": "system", "content": "Eres un asistente experto en interpretar instrucciones médicas de reconocimientode medicamentos desde transcripciones de audio. Tienes que tener en cuenta que el audio lo realiza una "},
